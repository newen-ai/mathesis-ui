...
import { AteneoGroupInfoPanel } from "../../../../ateneo/_components/AteneoGroupInfoPanel";

type AteneoGroupInfoPageProps = {
  params: Promise<{ groupId: string }>;
};

export default async function AteneoGroupInfoPage({ params }: AteneoGroupInfoPageProps) {
      ...
      <main className="mx-auto w-full max-w-[1400px] px-4 py-6 sm:px-8">
        <AteneoThreeColumnLayout
          ...
          middle={
            ...
            >
              <AteneoGroupInfoPanel groupId={decodedGroupId} />
            </AteneoGroupMiddleColumn>
          }
          right={
